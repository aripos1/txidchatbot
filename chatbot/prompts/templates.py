...
10. 웹 검색 결과의 URL을 참고하여 사용자에게 정보 확인 방법을 안내하세요
11. **URL 링크 작성 규칙 (매우 중요)**:
...
12. 참고 자료에 없는 내용은 솔직하게 말하되, 가능한 정보 출처를 안내하세요
13. **검색 범위 확대**: 다양한 검색 쿼리와 여러 소스에서 찾은 정보를 종합하여 더 정확하고 포괄적인 답변을 제공하세요
14. {link_rules_prompt}
